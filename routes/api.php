...
Route::group(['prefix' => 'user' ,'as' => 'user.', 'middleware' => 'cors'], function() {
    ...
    Route::post('live_stream_chat_messages_list', 'ApplicationController@live_stream_chat_messages_list');

    Route::any('chat_broadcast_messages_save', 'ApplicationController@chat_broadcast_messages_save');
    ...
    Route::post('inapp_purchase_ios','ApplicationController@inapp_purchase_ios');
    ...
    Route::group(['middleware' => 'UserApiVal'] , function() {
        ...
        Route::post('update_show_followings','Api\UserAccountApiController@update_show_followings');
        ...
        Route::post('wallets_add_money_by_stripe_ios', 'Api\WalletApiController@user_wallets_add_money_by_stripe_ios');

        Route::post('wallets_add_money_by_stripe_ios_status', 'Api\WalletApiController@user_wallets_add_money_by_stripe_ios_status');
    ...
    Route::group(['middleware' => 'UserApiVal'] , function() {
        ...
        Route::group(['middleware' => 'CheckDocumentVerify'] , function() {
            ...
            Route::post('view_product_file','Api\UserProductApiController@view_product_file');
            ...
            Route::post('digital_product_payment_by_wallet', 'Api\UserProductApiController@digital_product_payment_by_wallet');
    ...
    Route::group(['middleware' => 'UserApiVal'] , function() {
        ...
        Route::post('chat_asset_broadcast_files_upload', 'Api\ChatApiController@chat_asset_broadcast_files_upload');
        ...
        Route::post('send_bulk_message','Api\ChatApiController@send_bulk_message');
        ...
        Route::post('video_call_requests_start', 'Api\VideoCallApiController@video_call_requests_start');
        ...
        Route::post('audio_call_requests_start', 'Api\AudioCallApiController@audio_call_requests_start');
    ...
    Route::group(['middleware' => 'UserApiVal'] , function() {
        ...
        Route::post('live_videos_host_update', 'Api\LiveVideoApiController@live_videos_host_update');
        ...
        Route::post('tips_payment_by_iap','Api\InAppPurchaseController@tips_payment_by_iap');

        Route::post('live_videos_payment_by_iap','Api\InAppPurchaseController@live_videos_payment_by_iap');

        Route::post('video_call_payment_by_iap','Api\InAppPurchaseController@video_call_payment_by_iap');

        Route::post('audio_call_payment_by_iap','Api\InAppPurchaseController@audio_call_payment_by_iap');

        Route::post('chat_assets_payment_by_iap','Api\InAppPurchaseController@chat_assets_payment_by_iap');

        Route::post('user_subscriptions_payment_by_iap','Api\InAppPurchaseController@user_subscriptions_payment_by_iap');

        Route::post('post_payment_by_iap','Api\InAppPurchaseController@post_payment_by_iap');

        Route::post('file_archives_index','Api\FileArchiveController@file_archives_index');

        Route::post('file_archives_view','Api\FileArchiveController@file_archives_view');

    });

    Route::group(['middleware' => 'UserApiVal'] , function() {

        Route::controller(Api\VirtualExperience\UserVirtualExperienceController::class)->group(function() {

            Route::group(['prefix' => 'user_virtual_experiences'], function() {
            ...
            Route::group(['prefix' => 'user_vh_bookings'], function() {
        ...
        Route::controller(Api\VirtualExperience\CreatorVirtualExperienceController::class)->group(function() {

            Route::group(['prefix' => 'virtual_experiences'], function() {
                ...
                Route::post('virtual_experience_host_update', 'virtual_experience_host_update');

            });

            Route::group(['prefix' => 'virtual_experience_bookings'], function() {
                ...
                Route::post('end_virtual_experience', 'end_virtual_experience');

                Route::post('start_virtual_experience', 'start_virtual_experience');

                Route::post('creator_availabilities', 'creator_availabilities');
            });
        });
        ...
        Route::controller(Api\PersonalizedRequestController::class)->group(function() {
            ...
            Route::group(['prefix' => 'personalize_requests'], function() {
                ...
                Route::post('personalized_request_sent', 'personalized_request_sent');

                Route::post('personalized_request_received', 'personalized_request_received');

                Route::post('personalized_request_update_by_creator', 'personalized_request_update_by_creator');

                Route::post('personalized_request_status_update_by_creator', 'personalized_request_status_update_by_creator');

                Route::post('create_product_for_personalize_request', 'create_product_for_personalize_request');

                Route::post('personalize_product_files_save', 'personalize_product_files_save');

                Route::post('personalize_product_file_delete', 'personalize_product_file_delete');

                Route::post('personalized_request_payment_by_wallet', 'personalized_request_payment_by_wallet');

                Route::post('personalize_request_product_response', 'personalize_request_product_response');

                Route::post('creator_update_request_file', 'creator_update_request_file');

                Route::post('request_reject_by_user', 'request_reject_by_user');

                Route::post('request_cancel_by_user', 'request_cancel_by_user');

                Route::post('personalized_delivery_address_list', 'personalized_delivery_address_list');

            });
        });

        Route::controller(Api\LiveStreamShoppingController::class)->group(function() {

            Route::group(['prefix' => 'live_stream_shoppings'], function() {

                Route::post('create_live_stream', 'create_live_stream');

                Route::post('live_stream_shoppings_view', 'live_stream_shoppings_view');

                Route::post('live_stream_shopping_products', 'live_stream_shopping_products');

                Route::post('ongoing_live_stream_shopping', 'ongoing_live_stream_shopping');
                Route::post('scheduled_live_stream_shoppings', 'scheduled_live_stream_shoppings');

                Route::post('lss_product_orders_list', 'lss_product_orders_list');

                Route::post('lss_product_payment_by_wallet', 'lss_product_payment_by_wallet');

                Route::post('creator_update_shipping_url', 'creator_update_shipping_url');

                Route::post('lss_order_products_view', 'lss_order_products_view');

                Route::post('live_stream_shopping_end', 'live_stream_shopping_end');

                Route::post('live_stream_shoppings_history', 'live_stream_shoppings_history');

                Route::post('live_stream_shopping_payment_by_wallet', 'live_stream_shopping_payment_by_wallet');

                Route::post('lss_product_orders_recieved_list', 'lss_product_orders_recieved_list');

                Route::post('lss_delivery_address_list', 'lss_delivery_address_list');

                Route::post('lss_delivery_address_store', 'lss_delivery_address_store');

                Route::post('lss_delivery_addrees_make_as_default', 'lss_delivery_addrees_make_as_default');

                Route::post('lss_delivery_addrees_delete', 'lss_delivery_addrees_delete');

                Route::post('update_shipping_status', 'update_shipping_status');
                
                Route::post('creator_live_stream_shoppings', 'creator_live_stream_shoppings');

                Route::post('lss_products', 'lss_products');
