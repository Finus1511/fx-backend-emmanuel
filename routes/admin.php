...
Route::group(['middleware' => 'web'], function() {
    ...
    Route::group(['as' => 'admin.', 'prefix' => 'admin'], function(){
        ...
        Route::get('featured_users', 'Admin\AdminUserController@featured_users_index')->name('featured_users.index');

        Route::get('users/marked_as_featured_user', 'Admin\AdminUserController@marked_as_featured_user')->name('users.marked_as_featured_user');

        Route::get('users/remove_featured_user', 'Admin\AdminUserController@remove_featured_user')->name('users.remove_featured_user');
        ...
        // Inapp purchase CRUD Operations

        Route::get('inapp_purchases', 'Admin\AdminLookupController@inapp_purchases_index')->name('inapp_purchases.index');

        Route::get('inapp_purchases/create', 'Admin\AdminLookupController@inapp_purchases_create')->name('inapp_purchases.create');

        Route::get('inapp_purchases/edit', 'Admin\AdminLookupController@inapp_purchases_edit')->name('inapp_purchases.edit');

        Route::post('inapp_purchases/save', 'Admin\AdminLookupController@inapp_purchases_save')->name('inapp_purchases.save');

        Route::get('inapp_purchases/view', 'Admin\AdminLookupController@inapp_purchases_view')->name('inapp_purchases.view');

        Route::get('inapp_purchases/delete', 'Admin\AdminLookupController@inapp_purchases_delete')->name('inapp_purchases.delete');

        Route::get('inapp_purchases/status', 'Admin\AdminLookupController@inapp_purchases_status')->name('inapp_purchases.status');
      ...
      // liked posts route start
        ...
        Route::get('admin_chat_messages/index','Admin\AdminChatController@admin_chat_messages')->name('admin_chat_messages.index');

        Route::get('chat_users/index','Admin\AdminLiveVideoController@chat_user_messages')->name('chat_users.messages');

        Route::get('chat_users/messages','Admin\AdminLiveVideoController@chat_users_index')->name('chat_users.index');
        ...
        Route::get('wallet_payments/index','Admin\AdminRevenueController@wallet_payments_index')->name('wallet_payments.index');

        Route::get('wallet_payments/excel','Admin\AdminRevenueController@wallet_payments_excel')->name('wallet_payments.excel');

        Route::get('wallet_payments/view','Admin\AdminRevenueController@wallet_payment_view')->name('wallet_payments.view');

        // Personalize Requests

        Route::get('personalize_requests/index','Admin\AdminPersonalizedRequestController@index')->name('personalized_requests.index');

        Route::get('personalize_requests/products','Admin\AdminPersonalizedRequestController@products')->name('personalized_requests.products');

        Route::get('personalize_requests/view','Admin\AdminPersonalizedRequestController@view')->name('personalized_requests.view');

        Route::get('personalize_requests/products_view','Admin\AdminPersonalizedRequestController@products_view')->name('personalized_products.view');


        //Live stream shopping

        Route::get('live_stream_shoppings', 'Admin\LiveStreamShoppingController@live_stream_shoppings')->name('live_stream_shoppings.index');

        Route::get('live_stream_shoppings_view', 'Admin\LiveStreamShoppingController@live_stream_shoppings_view')->name('live_stream_shoppings.view');

        Route::get('live_stream_shopping_payments', 'Admin\LiveStreamShoppingController@live_stream_shopping_payments')->name('live_stream_shoppings.payments');
