            ...
            <div class="card post-payment-sec">
                ...
                <div class="card-header border-bottom border-gray">
                   ...
                   <div class="heading-elements">
                        ...
                        <a href="{{ route('admin.live_video_payment.excel',['live_video_id'=>Request::get('live_video_id'),'search_key'=>Request::get('search_key'),'user_id'=>Request::get('user_id'),'file_format'=>'.csv']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_csv')}}</a>

                        <a href="{{ route('admin.live_video_payment.excel',['live_video_id'=>Request::get('live_video_id'),'search_key'=>Request::get('search_key'),'user_id'=>Request::get('user_id'),'file_format'=>'.xls']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_xls')}}</a>

                        <a href="{{ route('admin.live_video_payment.excel',['live_video_id'=>Request::get('live_video_id'),'search_key'=>Request::get('search_key'),'user_id'=>Request::get('user_id'),'file_format'=>'.xlsx']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_xlsx')}}</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.live_videos.payments.send_invoice',['live_video_payment_id' => $live_video_payment->id])}}" class="btn btn-primary"><i class="fa fa-envelope"></i>&nbsp;{{tr('send_invoice')}}</a>
