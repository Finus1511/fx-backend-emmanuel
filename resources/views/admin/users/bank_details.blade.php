                    ...
                    <div class="table-responsive">
                                ...
                                <div class="col-xs-12 col-sm-12 col-lg-6 col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="user_id" id="user_id" value="{{ $user->id}}">
                                         ...
                                         <input type="text" class="form-control" name="search_key" value="{{Request::get('search_key')??''}}" placeholder="{{Str::limit(tr('bank_search_placeholder'),66)}}" title="{{tr('bank_search_placeholder')}}">
                        ...
                        <table id="dataTable" class="table table-bordered table-striped display nowrap margin-top-10">
                            ...
                            <tbody>
                                 ...
                                 @foreach($billing_accounts as $i => $billing_account)
                                <tr>

                                    <td>{{ $i+$billing_accounts->firstItem() }}</td>

                                     <td class="white-space-nowrap">
                                        {{ $billing_account->first_name ?: tr('not_available')}}
                                    </td>

                                     <td class="white-space-nowrap">
                                        {{$billing_account->last_name ?: tr('not_available')}}
                                    </td>

                                     <td>
                                        {{$billing_account->account_number ?: tr('not_available')}}
                                    </td>

                                    <td class="white-space-nowrap">
                                        {{$billing_account->route_number ?: tr('not_available')}}
                                    </td>

                                    <td>
                                        @if($billing_account->bank_type == BANK_TYPE_SAVINGS)
                                    ...
                                    <td>
                                        {{$billing_account->business_name ?: tr('not_available')}}
                                    </td>

                                    <td>
                                        @if($billing_account->is_default == YES)
                        ...
                        <div class="pull-right" id="paglink">{{ $billing_accounts->appends(request()->input())->links('pagination::bootstrap-4') }}</div>
                    </div>
