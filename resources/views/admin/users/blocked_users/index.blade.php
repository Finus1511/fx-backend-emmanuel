                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                <a class="dropdown-item" onclick="return confirm(&quot;{{ tr('unblock_accounts' , $user->blockeduser->name ?? '') }}&quot;);" href="{{ route('admin.block_users.delete', ['user_id' => $user->blocked_to,'page'=>request()->input('page')] ) }}">&nbsp;{{ tr('unblock_from_all_accounts') }}</a>
