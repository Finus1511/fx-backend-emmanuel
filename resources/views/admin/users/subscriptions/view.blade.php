                                ...
                                <table id="dataTable" class="table table-bordered table-striped display nowrap margin-top-10">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.users.view',['user_id'=>$user_subscription_payment->from_user_id ?? ''])}}">
                                                    {{Str::limit($user_subscription_payment->from_username,20) ?: tr('not_available')}}
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.users.view',['user_id'=>$user_subscription_payment->to_user_id ?? ''])}}">
                                                    {{Str::limit($user_subscription_payment->to_username ,20) ?: tr('not_available')}}
                                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{  strtolower($user_subscription_payment->payment_mode)?: tr('n_a')}}</td>
                                        </tr>


                                        <tr>
                                            <td>{{ tr('plan_type')}} </td>
                                             <td>{{ $user_subscription_payment->plan_type ?: tr('n_a')}}</td>
                                        </tr>
                            ...
                            <div class="col-md-6">
                                ...
                                <table id="dataTable" class="table table-bordered table-striped display nowrap margin-top-10">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ tr('cancellation_of_subscription') }}</td>
                                            <td>
