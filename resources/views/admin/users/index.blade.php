                ...
                <div class="heading-elements">
                    ...
                    <div class="float-right ml-2">
                        ...
                        <div class="dropdown-menu float-right" aria-labelledby="export_to_excel">
                            ...
                            <a class="dropdown-item action_list" href="{{ route('admin.users.excel',['downloadexcel'=>'excel','status'=>Request::get('status'),'search_key'=>Request::get('search_key'),'account_type'=>Request::get('account_type'),'document_status'=>Request::get('document_status'),'is_content_creator'=>Request::get('is_content_creator'),'file_format'=>'.csv']) }}">
                               {{tr('export_to_csv')}}
                            </a>

                            <a class="dropdown-item action_list" href="{{ route('admin.users.excel',['downloadexcel'=>'excel','status'=>Request::get('status'),'document_status'=>Request::get('document_status'),'search_key'=>Request::get('search_key'),'is_content_creator'=>Request::get('is_content_creator'),'account_type'=>Request::get('account_type'),'file_format'=>'.xls']) }}">
                               {{tr('export_to_xls')}}
                            </a>

                            <a class="dropdown-item action_list" href="{{ route('admin.users.excel',['downloadexcel'=>'excel','status'=>Request::get('status'),'document_status'=>Request::get('document_status'),'search_key'=>Request::get('search_key'),'is_content_creator'=>Request::get('is_content_creator'),'account_type'=>Request::get('account_type'),'file_format'=>'.xlsx']) }}">
                               {{tr('export_to_xlsx')}}
                            </a>
                        </div>
                    </div>
