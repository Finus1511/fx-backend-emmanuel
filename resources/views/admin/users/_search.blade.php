<form method="GET" action="{{route('admin.users.index')}}">
    ...
    <div class="row">
        ...
        <input type="hidden" id="is_content_creator" name="is_content_creator" value="{{Request::get('is_content_creator') ?? ''}}">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-3 col-md-6 md-full-width resp-mrg-btm-md">
          ...
          <div class="col-xs-12 col-sm-12 col-lg-3 col-md-2 md-full-width resp-mrg-btm-md">
            ...
            <select class="form-control select2" name="is_content_creator">

                <option class="select-color" value="">{{tr('select_content_creator')}}</option>

                <option class="select-color" value="{{CONTENT_CREATOR}}" @if(Request::get('is_content_creator') == CONTENT_CREATOR && Request::get('is_content_creator')!='' ) selected @endif>{{tr('yes')}}</option>

                <option class="select-color" value="{{DEFAULT_USER}}" @if(Request::get('is_content_creator') == DEFAULT_USER && Request::get('is_content_creator')!='' ) selected @endif>{{tr('no')}}</option>
