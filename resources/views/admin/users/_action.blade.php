...
<!--     <div class="dropdown-menu action-dropdown-menu dropdown-grid cols-4"> -->
    <div class="dropdown-menu dropdown-grid cols-4 action-dropdown-menu">
        ...
        <a class="dropdown-item" href="{{route('admin.wallet_payments.index',['user_id' => $user->id])}}">
            <img class="icon" src="{{asset('admin-assets/vendors/flat-color-icons/money_transfer.svg')}}" alt="audio.svg"/>
            <span class="title">{{tr('wallet_payments')}}</span>
        </a>
        ...
        <a class="dropdown-item" href="{{route('admin.live_stream_shoppings.payments',['user_id' => $user->id])}}">
            <img class="icon" src="{{asset('admin-assets/vendors/flat-color-icons/withdraw.svg')}}" alt="subscription-payments.svg"/>
            <span class="title">{{tr('live_stream_shopping_payments')}}</span>
        </a>

        <a class="dropdown-item" href="{{route('admin.live_stream_shoppings.product_payments',['user_id' => $user->id])}}">
            <img class="icon" src="{{asset('admin-assets/vendors/flat-color-icons/currency_exchange.svg')}}" alt="subscription-payments.svg"/>
            <span class="title">{{tr('live_stream_shopping_product_payments')}}</span>
        </a>

        @if($user->is_content_creator == CONTENT_CREATOR)

          <a onclick="return confirm(&quot;{{ tr('marked_as_featured_user_confirmation' , $user->name) }}&quot;);" class="dropdown-item" href="{{ route('admin.users.marked_as_featured_user', ['user_id' => $user->id] ) }}">
                <img class="icon" src="{{asset('admin-assets/vendors/flat-color-icons/todo_list.svg')}}" alt="photo_reel.svg"/>
                <span class="title">{{ tr('marked_as_featured_user') }}</span>
            </a>

             <a class="dropdown-item" href="{{route('admin.live_stream_shoppings.index',['user_id' => $user->id])}}">
            <img class="icon" src="{{asset('admin-assets/vendors/flat-color-icons/no_video.svg')}}" alt="subscription-payments.svg"/>
            <span class="title">{{tr('live_stream_shoppings')}}</span>
        </a>

        @endif
          <a class="dropdown-item" href="{{route('admin.personalized_requests.index',[$user->is_content_creator == CONTENT_CREATOR ? 'receiver_id' : 'sender_id' => $user->id])}}">
            <img class="icon" src="{{asset('admin-assets/vendors/flat-color-icons/refresh.svg')}}" alt="subscription-payments.svg"/>
            <span class="title">{{tr('personalized_requests')}}</span>
        </a>
        {{-- Payments ends --}}
