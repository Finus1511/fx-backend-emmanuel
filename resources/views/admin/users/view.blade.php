                            ...
                            <div class=" col-xl-6 col-lg-6 col-md-12">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-xl mb-0">
                                        ...
                                        <tr>
                                            <th>{{tr('referral')}}</th>
                                            <td> <a href="{{ route('admin.referrals.view',['referral_id' => $referral_code->referral_code_id])}}">
                                                {{$referral_code->referral_code ?: tr('na')}}
                                            </a>
                                            </td>
                                        </tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-12">
                                         ...
                                         <div class="col-xl-4 col-lg-4 col-md-12">
                                            ...
                                            <a class="btn btn-block btn-social btn-github mr-1 mb-2 " href="{{route('admin.wallet_payments.index', ['user_id'=>$user->id] )}}">
                                        ...
                                        <a href="{{route('admin.stories.index',['user_id' => $user->id])}}" class="btn btn-block btn-social btn-bitbucket mr-1 mb-2">
                                         ...
                                         <div class="col-xl-4 col-lg-4 col-md-12">
                                            ...
                                            <a href="{{route('admin.personalized_requests.index',[$user->is_content_creator == CONTENT_CREATOR ? 'receiver_id' : 'sender_id' => $user->id])}}" class="btn btn-block btn-social btn-dropbox mr-1 mb-2">
                                            <i class="fa fa-exchange-alt"></i>
                                                {{tr('personalized_requests')}}
                                            </a>
