                        ...
                        <table id="checkBoxData" class="table table-bordered table-striped display nowrap margin-top-10">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.users.index', ['category_id' => $category->id] ) }}" class="badge badge-success">
                                        {{ $category->total_users  ?: 0}}
                                        </a>
                                    </td>

                                     <td>
                                        <a href="{{ route('admin.posts.index', ['category_id' => $category->id] ) }}" class="badge badge-success">
