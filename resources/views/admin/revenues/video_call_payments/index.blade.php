            ...
            <div class="card post-payment-sec">
                ...
                <div class="card-header border-bottom border-gray">
                    ...
                    <div class="heading-elements">
                        ...
                        <a href="{{ route('admin.video_call_payment.excel',['user_id'=>Request::get('user_id'),'search_key'=>Request::get('search_key'),'status'=>Request::get('status'),'file_format'=>'.csv']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_csv')}}</a>

                        <a href="{{ route('admin.video_call_payment.excel',['user_id'=>Request::get('user_id'),'search_key'=>Request::get('search_key'),'status'=>Request::get('status'),'file_format'=>'.xls']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_xls')}}</a>

                        <a href="{{ route('admin.video_call_payment.excel',['user_id'=>Request::get('user_id'),'search_key'=>Request::get('search_key'),'status'=>Request::get('status'),'file_format'=>'.xlsx']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_xlsx')}}</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.video_call_payments.send_invoice',['video_call_payment_id' => $video_call_payment->id])}}" class="btn btn-primary"><i class="fa fa-envelope"></i>&nbsp;{{tr('send_invoice')}}</a>
