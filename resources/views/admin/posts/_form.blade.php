                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="radio" class="with-gap" id="{{POSTS_IMAGE}}"
                                        ...
                                        {{ $post->id && !empty($post_files) && isset($post_files[0]) ? ($post_files && $post_files[0]->file_type  == POSTS_IMAGE ? "checked" : "") : ""}}>
                                    ...
                                    <input type="radio" class="with-gap" id="{{POSTS_VIDEO}}"
                                        ...
                                        {{ $post->id && !empty($post_files) && isset($post_files[0]) ? (($post_files && $post_files[0]->file_type  == POSTS_VIDEO) ? "checked" : "") : ""}}>
                                    ...
                                    <input type="radio" class="with-gap" id="{{POSTS_AUDIO}}"
                                        ...
                                        {{ $post->id && !empty($post_files) && isset($post_files[0]) ? (($post_files && $post_files[0]->file_type  == POSTS_AUDIO) ? "checked" : "") : ""}}>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" name="content"
                                        class="form-control" required>{{ $post->content_formatted ?: old('content') }}</textarea>
                                </div>
                            </div>
