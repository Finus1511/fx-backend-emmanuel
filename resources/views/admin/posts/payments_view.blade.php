                            ...
                            <div class="col-md-6">
                                ...
                                <table id="dataTable" class="table table-bordered table-striped display nowrap margin-top-10">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('unique_id')}} </td>
                                            <td class="text-uppercase">{{ $post_payment->unique_id ?: tr('n_a')}}</td>
                                        </tr>

                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('post_id')}} </td>
                                            <td>
                                                <a href="{{route('admin.posts.view',['post_id'=>$post_payment->post_id ?? ''])}}">
                                                {{ $post_payment->postDetails->unique_id ?? tr('n_a')}}
                                                </a>
                                            </td>
                                        </tr>
                                       ...
                                       <tr>
                                         <tr>
                                            <td class=" heading-text-weight">{{ tr('post_content')}} </td>
                                            <td>
                                                <a href="{{ route('admin.posts.view', ['post_id' => $post_payment->post_id])}}">
                                        ...
                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('paid_user_name')}} </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('paid_amount') }}</td>
                                            <td>{{ $post_payment->paid_amount_formatted ?: 0}}</td>
                                        </tr>

                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('admin_amount') }}</td>
                                            <td>{{ $post_payment->admin_amount_formatted ?: 0}}</td>
                                        </tr>

                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('user_amount') }}</td>
                            ...
                            <div class="col-md-6">
                                 ...
                                 <table id="dataTable" class="table table-bordered table-striped display nowrap margin-top-10">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('payment_mode')}} </td>
                                            <td>{{ strtolower($post_payment->payment_mode) ?: tr('n_a')}}</td>
                                        </tr>

                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('paid_date') }}</td>
                                        ...
                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('is_failed') }}</td>
                                            <td>
                                        ...
                                        @if($post_payment->is_failed ==YES)
                                        <tr>
                                            <td class=" heading-text-weight">{{ tr('failed_reason') }}</td>
