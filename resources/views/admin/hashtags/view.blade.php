            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card user-profile-view-sec">
                    ...
                    <div class="card-header border-bottom border-gray">
                       ...
                       <h4 class="card-title">{{ tr('view_hashtags')}} - {{$hashtag->name ?: tr('n_a')}}</h4>
                    </div>
                                    ...
                                    <div class="px-2 resp-marg-top-xs">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12">
                                                 ...
                                                 <a class="btn btn-danger btn-block btn-min-width mr-1 mb-1"  href="{{ route('admin.hashtags.edit', ['hashtag_id' => $hashtag->id,'page'=>request()->input('page')] ) }}">&nbsp;{{tr('edit')}}</a>
