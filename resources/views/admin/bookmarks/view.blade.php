        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-header border-bottom border-gray">
                    ...
                    <a class="dropdown-item"   onclick="return confirm(&quot;{{ tr('bookmark_delete_confirmation' , $post_bookmark->post->content ?? '') }}&quot;);" href="{{ route('admin.bookmarks.delete', ['post_bookmark_id' => $post_bookmark->id, 'user_id' => $post_bookmark->user_id,'page'=>request()->input('page')] ) }}" class="btn btn-primary">&nbsp;{{ tr('remove') }}</a>
