                        ...
                        <table id="dataTable" class="table table-bordered table-striped display nowrap margin-top-10">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user_withdrawal->payment_id ?: tr('n_a')}}</td>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm popup-label">
                        <b class="label-font">{{tr('first_name')}}</b>
                        <p>{{$withdrawal_details->billingAccount->first_name ?? tr('not_available') }}</p>
                    </div>

                     <div class="col-sm popup-label">
                        <b class="label-font">{{tr('last_name')}}</b>
                        <p>{{$withdrawal_details->billingAccount->last_name ?? tr('not_available') }}</p>
                    </div>
                ...
                <div class="row">
                       ...
                       <div class="col-sm popup-label">
                        <b class="label-font">{{tr('bussiness_name')}}</b>
                        <p>{{$withdrawal_details->billingAccount->business_name ?? tr('not_available') }}</p>
                    </div>
