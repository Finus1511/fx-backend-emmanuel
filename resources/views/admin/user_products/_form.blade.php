                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step=".01" min="1" pattern="[0-9]{6,13}" id="price" name="price" class="form-control" placeholder="{{tr('price')}}" value="{{(Setting::get('is_only_wallet_payment') ? $user_product->token : $user_product->price) ?: old('price') }}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                        ...
                                        <label for="category">{{tr('choose_category')}} *</label>
                                           ...
                                           <div class="heading-elements new-text-style">
                                        <a href="{{ route('admin.product_categories.create') }}" class="btn btn-primary"><i class="ft-user icon-left"></i>{{ tr('add_category') }}</a>
                                         </div>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <label for="product_sub_category_id">{{tr('choose_product_sub_category')}} *</label>
                                        ...
                                        <div class="heading-elements new-text-style ">
                                        <a href="{{ route('admin.product_sub_categories.create') }}" class="btn btn-primary"><i class="ft-user icon-left"></i>{{ tr('add_sub_category') }}</a>
                                         </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="picture" accept="image/png,image/jpeg" required="">
