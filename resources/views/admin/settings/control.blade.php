                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                           ...
                                                           <label>{{ tr('in_app_purchase_enabled') }}</label>
                                                           <br>
                                                            <input required type="radio" id="in_app_purchase_enabled_yes" name="in_app_purchase_enabled" value="1" class="with-gap" @if(Setting::get('in_app_purchase_enabled') == 1) checked @endif>
                                                           <label for="in_app_purchase_enabled_yes">
                                                               {{tr('yes')}}
                                                           </label>

                                                            <input required type="radio" id="in_app_purchase_enabled_no" name="in_app_purchase_enabled" class="with-gap"  value="0" @if(Setting::get('in_app_purchase_enabled') == 0) checked @endif>
                                                           <label for="in_app_purchase_enabled_no">
                                                               {{tr('no')}}
                                                           </label>
