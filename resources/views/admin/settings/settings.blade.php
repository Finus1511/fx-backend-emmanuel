                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label for="ppv_image_placeholder">{{tr('audio_thumbnail_placeholder')}}</label>
                                
                                <input type="file" class="form-control" id="audio_thumbnail_placeholder" name="audio_thumbnail_placeholder" accept="image/png,image/jpeg,image/jpg" placeholder="{{tr('audio_thumbnail_placeholder')}}">

                            </div>
                            @if(Setting::get('audio_thumbnail_placeholder'))

                                <img class="img img-thumbnail m-b-20" style="width: 50%" src="{{Setting::get('audio_thumbnail_placeholder')}}" alt="audio_thumbnail_placeholder"> 
