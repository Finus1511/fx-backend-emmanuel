							...
							@if($user_wallet_payments->isNotEmpty())
    							...
    							@foreach($user_wallet_payments as $i => $user_wallet_payment)
        							...
        							<tr>
        								...
        								<td>{{Setting::get('is_only_wallet_payment') ? formatted_amount($user_wallet_payment->token) : formatted_amount($user_wallet_payment->admin_amount + $user_wallet_payment->user_amount)}}
                                            @if($user_wallet_payment->payment_type != WALLET_PAYMENT_TYPE_ADD)
                                                <br><br>
