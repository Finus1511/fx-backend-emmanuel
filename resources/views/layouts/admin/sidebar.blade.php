...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li id="featured_users">
                <a href="{{route('admin.featured_users.index')}}">
                <i class="fa fa-user-friends"></i> <span>{{tr('featured_users')}}</span>
                </a>
            </li>
            <li id="premium-users">
            ...
            <li class="treeview" id="one-to-one">
                <a href="{{route('admin.audio_call_requests.index')}}">
                    ...
                    <span>{{tr('one_to_one_stream')}}</span>
                    <span class="pull-right-container"><i class="fa fa-angle-right pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
            ...
            @endif
            <li class="treeview" id="live_stream_shoppings">
                <a href="{{route('admin.audio_call_requests.index')}}">
                   <i class="fa fa-video-slash"></i>
                    <span>{{tr('live_stream_shoppings')}}</span>
                    <span class="pull-right-container"><i class="fa fa-angle-right pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li id="view_live_stream_ongoing"><a href="{{route('admin.live_stream_shoppings.index', ['status' => LIVE_STREAM_SHOPPING_ONGOING])}}">{{tr('ongoing')}}</a></li>
                    <li id="view_live_stream_history"><a href="{{route('admin.live_stream_shoppings.index')}}"> {{tr('history')}}</a></li>
                </ul>
            </li>
            <li id="admin-chats">
                <a href="{{route('admin.admin_chat_messages.index', ['sort_by' => ALL_USERS])}}">
                  <i class="fa fa-comment"></i><span>{{tr('admin_chats')}}</span>
                </a>
            </li>
            @endif
            <li id="collections">
            ...
            <li class="treeview" id="payments">
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="wallet_payments"><a href="{{route('admin.wallet_payments.index')}}">{{tr('wallet_payments')}}</a></li>
                    @if(Setting::get('is_one_to_many_call_enabled'))
            ...
            @if(Setting::get('in_app_purchase_enabled'))
            <li class="treeview" id="inapp_purchases">
                <a href="#">
                    <i class="fa fa-file"></i> <span>{{tr('inapp_purchases')}}</span>
                    <span class="pull-right-container"><i class="fa fa-angle-right pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li id="inapp_purchases-create"><a href="{{route('admin.inapp_purchases.create')}}">{{tr('add_inapp_purchase')}}</a></li>
                    <li id="inapp_purchases-view"><a href="{{route('admin.inapp_purchases.index')}}">{{tr('view_inapp_purchases')}}</a></li>
                </ul>
            </li>
            @endif
