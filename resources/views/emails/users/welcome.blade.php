            ...
            <tr>
              <td>
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td style="padding-bottom: 0;" class="content-cell" align="center">
                      <p class="f-fallback sub align-center">{{tr('you_are_receiving_mails_from')}} {{Setting::get('site_name')}}</p>
                    </td>
                  </tr>
                   <tr>
                    <td style="padding-top: 0;padding-bottom: 0;" class="content-cell" align="center">
                      <p class="f-fallback sub align-center">{{tr('social_media')}}</p>
                    </td>
                  </tr>
                    <tr style="border-collapse:collapse;">
                        <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:45px;font-size:0;">
