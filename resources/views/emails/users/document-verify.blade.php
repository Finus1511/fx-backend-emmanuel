                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                  <td class="attributes_item">
                                    <span class="f-fallback">{{Setting::get('site_name')}}</span>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="attributes_item">
                                    <span class="f-fallback" style="font-size: 12px;color: gray;text-transform: uppercase;">{{Setting::get('tag_name')}}</span>
                                  </td>
                                </tr>
                              </table>
                            </td>
