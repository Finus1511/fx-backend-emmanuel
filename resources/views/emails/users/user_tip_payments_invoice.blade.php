        ...
        <tr>
                                                    ...
                                                    <td class="attributes_content">
                                                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                            ...
                                                            <tr style="padding-bottom:30px !important;">
                                                                <td class="attributes_item">
                                                                    <span class="f-fallback">
                                                                        <strong>{{tr('date')}}:</strong> {{common_date($data['user_tip_payments']['paid_date'], $data['timezone'], 'd M Y')}}
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        </table>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <h3>{{$data['user_tip_payments']['payment_id'] ?? ''}}</h3>
                                                    </td>
                                                    <td>
                                                        <h3 class="align-right">{{common_date($data['user_tip_payments']['paid_date'], $data['timezone'], 'd M Y')}}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td width="80%" class="purchase_item"><span class="f-fallback">{{$data['amount']}}</span></td>
                                                                <td class="align-right" width="20%" class="purchase_item"><span class="f-fallback">{{ formatted_amount($data['user_tip_payments']['amount'] ?? 0.00,"","",NO)}}</span></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%" class="purchase_footer" valign="middle">
                                                                    <p class="f-fallback purchase_total">{{ formatted_amount($data['amount'] ?? 0.00)}}</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
