...
class CommonRepository {
     ...
     */
    public static function check_promo_code_applicable_to_user($user, $promo_code, $service_provider_id) {
     ...
     */
    public static function chat_user_update($from_user_id,$to_user_id, $admin_id=0) {
    ...
    * @method chat_messages_response()
    ...
    /**
     * @method update_file_archive()
     *
     * @uses when any file upload by user, will update the file archive
     *
     * @created vithya R
     *
     * @updated vithya R
    ...
    public static function update_file_archive($request) {
        ...
        // $request->request->add(['file' => "", 'origin' => , 'file_type' => "", "amount" => , 'is_paid' => '']);
        ...
        $file_archive->file_type = $request->file_type;

        $file_archive->amount = $request->amount;

        $file_archive->is_paid = $request->is_paid;
