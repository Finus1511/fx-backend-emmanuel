...
use App\Models\{User, VeOneOnOneFile};

use Illuminate\Http\Resources\Json\JsonResource;

class VeOneonOneResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $data = [
            ...
            'files' => VeOneOnOneFile::where('ve_one_on_one_id', $this->id)->get(),
            'title' => $this->title ? : '',
            ...
            'user_needs_to_pay' => is_creator_needs_to_pay_for_one_on_one_ve($this->id, $request->id),
            'virtual_experience_creator' => virtual_experience_one_on_one_creator_check($this->id, $request->id),
