...
class FollowersApiController extends Controller
{
    ...
    public function chat_users(Request $request) {
        ...
        try {
            ...
            $base_query = $total_query = \App\Models\ChatUser::with('admin')->where('from_user_id', $request->id)->whereNotIn('to_user_id',$blocked_user_ids)->whereHas('fromUser')->orderBy('chat_users.updated_at', 'desc');
