    ...
    public function promo_code_save(Request $request) {
        ...
        try {
            ...
            $rules = [
                ...
                'start_date' => 'required|after:now', // need guidance here
            ...
            $promo_code->platform = $request->platform ?: $promo_code->platform;
            ...
            if( $promo_code->save()) {
                ...
                $data['promo_code'] = PromoCodeResource::make($promocode);
